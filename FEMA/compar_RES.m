  function compar_RES(dir_name,storm_nam,date,type,LO_RES,HI_RES)
%
%  RE Jensen (02/2011)
%
...
filelowd = ['../../WAM_36_dir/WAM_4_5_1C/',dir_name,'/',storm_nam,'_',LO_RES,'.onlns'];
a = load(filelowd);

%filehig= ['../../Storm_18sec/WAM_4_5_1C/',dir_name,'/',storm_nam,'-',date,'-',type,'-',HI_RES,'-05D.onlns'];
filehigd = ['../../WAM_18_dir/WAM_4_5_1C/',dir_name,'/',storm_nam,'_',HI_RES,'.onlns'];
b = load(filehigd);
