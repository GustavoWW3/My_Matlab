function aa = conc_HUR_eval(buoy,model,level,yeard,mon1,mon2)
bas = 'HUR';
if isunix
    cc = ['/mnt/CHL_WIS_1/LAKE_HURON/Production/WAM451C/Validation/WIS/'];
else
    cc = ['Z:\LAKE_HURON\Production\WAM451C\Validation\WIS\'];
end
