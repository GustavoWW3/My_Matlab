function [tit,outdir] = SANDY_longterm_names(year1,year2,model,grid) 
%
%    ATL_longterm_names
...
tit1 = ['Sandy Recovery Longterm Analysis'];
tit2 = ['Model = ',model];
tit3 = ['Grid = ',grid];
...
outdir = ['/mnt/CHL_WIS_1/SANDY/Production/Longterm/'];
%outdir = ['/home/thesser1/Documents/WIS/Atlantic/Longterm/'];
if ~exist(outdir,'dir');
    mkdir(outdir);
end
