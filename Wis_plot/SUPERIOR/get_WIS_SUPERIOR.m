function get_WIS_SUPERIOR(outfile)
%
%   get_WIS_EXP
...
if isunix
   ...
   get_file = ['/mnt/CHL_WIS_1/LakeSuperior/Production/WAM451C/Model/',outfile(end-6:end),'/'];
...
for zz = 1:length(loc)
    ...
    wis_read('SUPERIOR',year,mon,'/',fillm,'iceC',iceC)
