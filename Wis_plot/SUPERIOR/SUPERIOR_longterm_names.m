function [tit,outdir] = SUPERIOR_longterm_names(year1,year2,model,grid) 
%
%    GOM_longterm_names
...
tit1 = ['Lake Superior Longterm Analysis'];
tit2 = ['Model = ',model];
tit3 = ['Grid = ',grid];
...
outdir = ['/mnt/CHL_WIS_1/LAKE_SUPERIOR/Production/Longterm/'];
if ~exist(outdir,'dir');
    mkdir(outdir);
end
