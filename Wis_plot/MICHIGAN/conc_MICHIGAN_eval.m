function aa = conc_MICHIGAN_eval(buoy,model,level,yeard,mon1,mon2)
bas = 'MICHIGAN';
if isunix
    cc = ['/mnt/CHL_WIS_1/LAKE_MICHIGAN/Production/Validation/WIS/'];
else
    cc = ['X:\LAKE_MICHIGAN\Production\',model,'\Validation\WIS\'];
end
