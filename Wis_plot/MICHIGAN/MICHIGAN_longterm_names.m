function [tit,outdir] = MICHIGAN_longterm_names(year1,year2,model,grid) 
%
%    GOM_longterm_names
...
tit1 = ['Lake MICHIGAN Longterm Analysis'];
tit2 = ['Model = ',model];
tit3 = ['Grid = ',grid];
...
outdir = ['/mnt/CHL_WIS_1/LAKE_MICHIGAN/Production/Longterm/'];
if ~exist(outdir,'dir');
    mkdir(outdir);
end
