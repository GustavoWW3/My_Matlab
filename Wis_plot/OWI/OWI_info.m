...
%
% -------------------------------------------------------------------------
title1 = ['OWI storms'];  % Title for 
plotloc = '/home/thesser1/My_Matlab/Wis_plot/OWI/';  % Location of Matlab directory for basin
rdir = '/mnt/CHL_WIS_1/';  % Top level location of WIS raid
localdir='/home/thesser1/OWI_WW3/';  % Local directory of files
bdir = '/mnt/CHL_WIS_1/owi_work/Buoy_Locs/';
modelnm = 'WAM451C';  % Model information
