...
%ftp_trans_ww3
 title1 = ['Example Hindcast Study [OWI Winds]'];
 plotloc = '/home/thesser1/My_Matlab/Wis_plot/EXP/';
 rdir = '/mnt/CHL_WIS_1/';
...
ww3_cont(storm,track,modelnm,plotloc)
loc = pwd;
...
for zz = 1:length(stats)
    ...
    stats_calc(buoyc,buoy,wis,modelnm,bas,level,'m');
