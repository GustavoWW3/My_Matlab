function [tit,outdir] = GOM_longterm_names(year1,year2,model,grid) 
%
%    GOM_longterm_names
...
tit1 = ['Gulf of Mexico Basin Longterm Analysis'];
tit2 = ['Model = ',model];
tit3 = ['Grid = ',grid];
...
outdir = ['/mnt/CHL_WIS_1/GOM/Evaluation/WW3/Longterm/'];
if ~exist(outdir,'dir');
    mkdir(outdir);
end
