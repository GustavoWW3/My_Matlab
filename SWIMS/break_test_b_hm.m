...
for nn = 1:size(Hmo_comp_low_water_25_smooth,1)
    ...
    for qq = 1:size(BB,2)
        ...
        elseif aa == 2
            wave1d_simp_TG83_beta_osten
        elseif aa == 3
            wave1d_simp_TG83_beta_kamp
        elseif aa == 4
            wave1d_simp_TG83_rues
        elseif aa == 5
            wave1d_simp_JB07_stwave
        elseif aa == 6 
            wave1d_simp_JB07_osten
        elseif aa == 7
            wave1d_simp_JB07_kamp
        else
            wave1d_simp_JB07_rues
        end
...
for aa = 1:4
    subplot(4,1,1)
    if aa == 1
        plot(x,H_tot(:,hh(1,aa),7,aa),cc(2*aa-1:2*aa))
         subplot(4,1,2)
        plot(BB,error_tot2(:,aa),cc(2*aa-1:2*aa))
        hold on
    elseif aa == 4
        plot(x,H_tot(:,hh(1,aa),7,aa),'m:')
        subplot(4,1,2)
        plot(BB,error_tot2(:,aa),cc(9:11))
    else
...
for aa = 5:8
    subplot(4,1,3)
    if aa == 5
        plot(x,H_tot(:,hh(1,aa),7,aa),cc(1:2))
         subplot(4,1,4)
        plot(BB,error_tot2(:,aa),cc(1:2))
        hold on
    elseif aa == 8
        plot(x,H_tot(:,hh(1,aa),7,aa),cc(9:11))
        subplot(4,1,4)
        plot(BB,error_tot2(:,aa),cc(9:11))
    else
        plot(x,H_tot(:,hh(1,aa),7,aa),cc(3*aa-15:3*aa-13))
        subplot(4,1,4)
        plot(BB,error_tot2(:,aa),cc(3*aa-15:3*aa-13))
    end
...
for aa = 1:4
    subplot(4,1,1)
    if aa == 1
        plot(BB,error_off(:,aa),cc(2*aa-1:2*aa))
        hold on
        subplot(4,1,2)
        plot(BB,error_break(:,aa),cc(2*aa-1:2*aa))
        hold on
        subplot(4,1,3)
        plot(BB,error_diss(:,aa),cc(2*aa-1:2*aa))
        hold on
        subplot(4,1,4)
        plot(BB,error_reef(:,aa),cc(2*aa-1:2*aa))
        hold on
    elseif aa == 4
        plot(BB,error_off(:,aa),cc(9:11))
        subplot(4,1,2)
        plot(BB,error_break(:,aa),cc(9:11))
        subplot(4,1,3)
        plot(BB,error_diss(:,aa),cc(9:11))
        subplot(4,1,4)
        plot(BB,error_reef(:,aa),cc(9:11))
    else
        plot(BB,error_off(:,aa),cc(3*aa-3:3*aa-1))
        subplot(4,1,2)
        plot(BB,error_break(:,aa),cc(3*aa-3:3*aa-1))
        subplot(4,1,3)
        plot(BB,error_diss(:,aa),cc(3*aa-3:3*aa-1))
        subplot(4,1,4)
        plot(BB,error_reef(:,aa),cc(3*aa-3:3*aa-1))
    end
...
for aa = 5:8
    subplot(4,1,1)
    if aa == 5
        plot(BB,error_off(:,aa),cc(1:2))
        hold on
        subplot(4,1,2)
        plot(BB,error_break(:,aa),cc(1:2))
        hold on
        subplot(4,1,3)
        plot(BB,error_diss(:,aa),cc(1:2))
        hold on
        subplot(4,1,4)
        plot(BB,error_reef(:,aa),cc(1:2))
        hold on
    elseif aa == 8
        plot(BB,error_off(:,aa),cc(9:11))
        subplot(4,1,2)
        ...
        plot(BB,error_off(:,aa),cc(3*aa-15:3*aa-13))
        subplot(4,1,2)
        plot(BB,error_break(:,aa),cc(3*aa-15:3*aa-13))
        subplot(4,1,3)
        plot(BB,error_diss(:,aa),cc(3*aa-15:3*aa-13))
        subplot(4,1,4)
        plot(BB,error_reef(:,aa),cc(3*aa-15:3*aa-13))
    end
...
for aa = 1:4
    subplot(5,1,1)
    if aa == 1
        plot(BB,error_tot_07(:,aa),cc(2*aa-1:2*aa))
        hold on
        subplot(5,1,2)
        plot(BB,error_tot_10(:,aa),cc(2*aa-1:2*aa))
        hold on
        subplot(5,1,3)
        plot(BB,error_tot_13(:,aa),cc(2*aa-1:2*aa))
        hold on
        subplot(5,1,4)
        plot(BB,error_tot_16(:,aa),cc(2*aa-1:2*aa))
        hold on
        subplot(5,1,5)
        plot(BB,error_tot_20(:,aa),cc(2*aa-1:2*aa))
        hold on
    elseif aa == 4
        plot(BB,error_tot_07(:,aa),cc(9:11))
        subplot(5,1,2)
        plot(BB,error_tot_10(:,aa),cc(9:11))
        subplot(5,1,3)
        plot(BB,error_tot_13(:,aa),cc(9:11))
        subplot(5,1,4)
        plot(BB,error_tot_16(:,aa),cc(9:11))
        subplot(5,1,5)
        plot(BB,error_tot_20(:,aa),cc(9:11))
    else
        plot(BB,error_tot_07(:,aa),cc(3*aa-3:3*aa-1))
        subplot(5,1,2)
        plot(BB,error_tot_10(:,aa),cc(3*aa-3:3*aa-1))
        subplot(5,1,3)
        plot(BB,error_tot_13(:,aa),cc(3*aa-3:3*aa-1))
        subplot(5,1,4)
        plot(BB,error_tot_16(:,aa),cc(3*aa-3:3*aa-1))
        subplot(5,1,5)
        plot(BB,error_tot_20(:,aa),cc(3*aa-3:3*aa-1))
    end
...
for aa = 5:8
    subplot(5,1,1)
    if aa == 5
        plot(BB,error_tot_07(:,aa),cc(1:2))
        hold on
        subplot(5,1,2)
        plot(BB,error_tot_10(:,aa),cc(1:2))
        hold on
        subplot(5,1,3)
        plot(BB,error_tot_13(:,aa),cc(1:2))
        hold on
        subplot(5,1,4)
        plot(BB,error_tot_16(:,aa),cc(1:2))
        hold on
        subplot(5,1,5)
        plot(BB,error_tot_20(:,aa),cc(1:2))
        hold on
    elseif aa == 8
        plot(BB,error_tot_07(:,aa),cc(9:11))
        subplot(5,1,2)
        ...
        plot(BB,error_tot_07(:,aa),cc(3*aa-15:3*aa-13))
        subplot(5,1,2)
        plot(BB,error_tot_10(:,aa),cc(3*aa-15:3*aa-13))
        subplot(5,1,3)
        plot(BB,error_tot_13(:,aa),cc(3*aa-15:3*aa-13))
        subplot(5,1,4)
        plot(BB,error_tot_16(:,aa),cc(3*aa-15:3*aa-13))
        subplot(5,1,5)
        plot(BB,error_tot_20(:,aa),cc(3*aa-15:3*aa-13))
    end
...
for aa = 1:4
    subplot(3,1,1)
    if aa == 1
        plot(BB,error_tot_lo(:,aa),cc(2*aa-1:2*aa))
        hold on
        subplot(3,1,2)
        plot(BB,error_tot_mi(:,aa),cc(2*aa-1:2*aa))
        hold on
        subplot(3,1,3)
        plot(BB,error_tot_hi(:,aa),cc(2*aa-1:2*aa))
        hold on
    elseif aa == 4
        plot(BB,error_tot_lo(:,aa),cc(9:11))
        subplot(3,1,2)
        plot(BB,error_tot_mi(:,aa),cc(9:11))
        subplot(3,1,3)
        plot(BB,error_tot_hi(:,aa),cc(9:11))
    else
        plot(BB,error_tot_lo(:,aa),cc(3*aa-3:3*aa-1))
        subplot(3,1,2)
        plot(BB,error_tot_mi(:,aa),cc(3*aa-3:3*aa-1))
        subplot(3,1,3)
        plot(BB,error_tot_hi(:,aa),cc(3*aa-3:3*aa-1))
    end
...
for aa = 5:8
    subplot(3,1,1)
    if aa == 5
        plot(BB,error_tot_lo(:,aa),cc(1:2))
        hold on
        subplot(3,1,2)
        plot(BB,error_tot_mi(:,aa),cc(1:2))
        hold on
        subplot(3,1,3)
        plot(BB,error_tot_hi(:,aa),cc(1:2))
        hold on
    elseif aa == 8
        plot(BB,error_tot_lo(:,aa),cc(9:11))
        subplot(3,1,2)
        ...
        plot(BB,error_tot_lo(:,aa),cc(3*aa-15:3*aa-13))
        subplot(3,1,2)
        plot(BB,error_tot_mi(:,aa),cc(3*aa-15:3*aa-13))
        subplot(3,1,3)
        plot(BB,error_tot_hi(:,aa),cc(3*aa-15:3*aa-13))
    end
