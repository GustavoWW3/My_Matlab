...
save H_tot_st.mat H_tot -V6
save error_only_st.mat error -V6
save error_st.mat error_tot error_tot2 error_off error_break error_diss error_reef BB gg gauge_x x -V6
save error_per_st.mat error_tot_07 error_tot_10 error_tot_13 error_tot_16 error_tot_20 -V6
save error_hig_st.mat error_tot_lo error_tot_mi error_tot_hi -V6
%hold off
 figure('inverthardcopy','off','color','white')
bg = error_tot2;
% %bg2(:,:) = error_tot2(:,:,2);
