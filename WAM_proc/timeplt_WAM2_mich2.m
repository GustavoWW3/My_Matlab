...
%         else
    ...
    if ~isempty(istn);
        ...
        %
        titcharpt1=['Lake Michigan FEMA Study [CFSR vs CFSR-ADJ]   '];
        ...
        for ii = 1:6
            ...
            if ii == 1
                ...
                hleg=legend(H,'BUOY','CFSR-ADJ','CFSR');
        ...
        %  Print out the file 
        %
        ffout = ['LKMI',int2str(buoy),'_',YRMT];
        ...
        if kkk == totlocs
            for ii = 1:totlocs
                ...
                if ii == 1
                    title1 = ['Lake Michigan FEMA Study [CFSR vs CFSR-ADJ]   '];
...
%                 end
        ...
        ff3 = ['scat-LKMI',int2str(buoy),'-',YRMT,'-',wtype{jjj},'-p1'];
...
%                 end
        ...
        ff2 = ['scat-LKMI',int2str(buoy),'_',YRMT,'-',wtype{jjj},'-p2'];
