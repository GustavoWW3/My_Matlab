function map_cont_PAC(pars,ice_coverin,storm,...
    track,modelnm)
%
%
...
%
%
%colposit = [0.2982 0.03 0.4500 0.0300];
legboxx=0.7;legboxy=0.92;
colposit = [0.2982 0.06 0.4500 0.0300];
project_in = 'mercator';
custerC=[1.,1.,1.];
%
...
%     end
    ...
    text(0.35,-.125,textcolbr,'FontWeight','bold','FontSize',8,'units','normalized');
    title(titlnam1,'FontWeight','bold');
    text(legboxx,legboxy,textstrt,'FontWeight','bold','FontSize',6,'units','normalized','BackgroundColor','w');
    %
