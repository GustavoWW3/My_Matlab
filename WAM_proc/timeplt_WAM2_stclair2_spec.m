function timeplt_WAM2_stclair2_spec(yrin, mntin,res,nw)
%
...
%for kkk=1:totlocs
    ...
    for ii = 1:nw
        ...
        AAtot = WAM_spec_onlns(filesb(kkk,1).name,0.2,0.3);
...
%         else
    ...
    %if ~isempty(istn);
        ...
        %
        for jjj = 1:nw
            filestats{jjj} = ['stats',num2str(buoy),'-',YRMT,'-',wtype{jjj},'.asc'];
        ...
        %
        titcharpt1=['Lake St. Clair FEMA Study [CFSR]   '];
        ...
        %  Print out the file 
        %
        ffout = ['STCL',int2str(buoy),'_',YRMT];
        ...
        for ii = 1:totlocs
            if ii == 1
              m_text(lonmp2(ii),latmp2(ii),buoylocs(ii,:),'fontsize',8,'HorizontalAlignment','left', ...
        ...
        if kkk == totlocs
            for ii = 1:totlocs
                ...
                if ii == 1
                    title1 = ['Lake St. Clair 1985 Study [CFSR vs CFSR-ADJ]   '];
        ...
        %
        fprintf(fidstats{jjj},'  %4.0f  %2.0f  %1.0f  %5.0f',yrin,mntin,recno1,buoy);
...
%                 end
        ...
        ff3 = ['scat-STCL',int2str(buoy),'-',YRMT,'-',wtype{jjj},'-p1'];
...
%                 end
        ...
        ff2 = ['scat-STCL',int2str(buoy),'_',YRMT,'-',wtype{jjj},'-p2'];
