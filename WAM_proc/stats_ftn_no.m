function [se, sd] = stat_ftn_no(a,b,buoy,YRMT,montit,YR1,titdom,filedom);
%
...
%  str = ['stats',filedom,int2str(buoy),'_',YRMT,'.txt'];
%  headstr=['          For Date = ',montit,' ',YR1,'   Domain =',titdom, '\n'];
%  fid = fopen(str,'w');
%  fprintf(fid,headstr);
...
% fprintf(fid,' DIR  %6.1f %5.1f %6.1f',xdb,sigx,ydb);
...
% fprintf(fid,' scl-xd  sigx scl-yd sigy vec-xd vec-yd diff sigma  ');
% fprintf(fid,' rho  phase   pts\n');
% fprintf(fid,' DIR  %6.1f %5.1f %6.1f',xdbwv,sigxwv,ydbwv);
